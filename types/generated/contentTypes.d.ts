...
export interface ApiMarcaMarca extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'nombre'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    tarifas: Schema.Attribute.Relation<'oneToMany', 'api::tarifa.tarifa'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTarifaTarifa extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tarifa.tarifa': ApiTarifaTarifa;
